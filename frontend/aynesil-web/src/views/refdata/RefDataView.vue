...
const REF_TYPES = [
  ...
  { code: 'service_type', labelKey: 'refData.types.service_type' },
  { code: 'payment_method', labelKey: 'refData.types.payment_method' },
  { code: 'package_type', labelKey: 'refData.types.package_type' },
  { code: 'scholarship_type', labelKey: 'refData.types.scholarship_type' },
  { code: 'discount_type', labelKey: 'refData.types.discount_type' },
  { code: 'student_status', labelKey: 'refData.types.student_status' },
  { code: 'enrollment_status', labelKey: 'refData.types.enrollment_status' },
  { code: 'gender', labelKey: 'refData.types.gender' },
  { code: 'employment_type', labelKey: 'refData.types.employment_type' },
  { code: 'educator_title', labelKey: 'refData.types.educator_title' },
  { code: 'specialty', labelKey: 'refData.types.specialty' },
  { code: 'certification_type', labelKey: 'refData.types.certification_type' },
  { code: 'lead_source', labelKey: 'refData.types.lead_source' },
  { code: 'lead_status', labelKey: 'refData.types.lead_status' },
  { code: 'pipeline_stage', labelKey: 'refData.types.pipeline_stage' },
  { code: 'activity_type', labelKey: 'refData.types.activity_type' },
  { code: 'assessment_type', labelKey: 'refData.types.assessment_type' },
  { code: 'assessment_category', labelKey: 'refData.types.assessment_category' },
  { code: 'goal_category', labelKey: 'refData.types.goal_category' },
  { code: 'development_area', labelKey: 'refData.types.development_area' },
  { code: 'diagnosis_category', labelKey: 'refData.types.diagnosis_category' },
  { code: 'guardian_relationship', labelKey: 'refData.types.guardian_relationship' },
  { code: 'attendance_reason', labelKey: 'refData.types.attendance_reason' },
  { code: 'leave_type', labelKey: 'refData.types.leave_type' },
  { code: 'meeting_type', labelKey: 'refData.types.meeting_type' },
  { code: 'room_type', labelKey: 'refData.types.room_type' },
  { code: 'institution_type', labelKey: 'refData.types.institution_type' },
  { code: 'consultancy_type', labelKey: 'refData.types.consultancy_type' },
  { code: 'observation_type', labelKey: 'refData.types.observation_type' },
  { code: 'agreement_type', labelKey: 'refData.types.agreement_type' },
  { code: 'contract_type', labelKey: 'refData.types.contract_type' },
  { code: 'consent_type', labelKey: 'refData.types.consent_type' },
  { code: 'camera_type', labelKey: 'refData.types.camera_type' },
  { code: 'access_type', labelKey: 'refData.types.access_type' },
  { code: 'camp_type', labelKey: 'refData.types.camp_type' },
  { code: 'camp_activity_type', labelKey: 'refData.types.camp_activity_type' },
  { code: 'academic_term', labelKey: 'refData.types.academic_term' },
  { code: 'kpi_category', labelKey: 'refData.types.kpi_category' },
  { code: 'report_category', labelKey: 'refData.types.report_category' },
]
